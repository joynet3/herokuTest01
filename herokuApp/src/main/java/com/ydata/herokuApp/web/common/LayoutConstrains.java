...
public interface LayoutConstrains {
    ...
    // login layout
    public static final String LAYOUT_LOGIN_TEMPLET_DIR = LAYOUT_BASE_DIR + "/login";

    public static final String LAYOUT_LOGIN_TEMPLET_URL = LAYOUT_LOGIN_TEMPLET_DIR + "/login-layout.jsp";

    public static final String LOGIN_HEADER_PATH = LAYOUT_LOGIN_TEMPLET_DIR + "/header.jsp";

    public static final String LOGIN_FOOTER_PATH = LAYOUT_LOGIN_TEMPLET_DIR + "/footer.jsp";

    // popup layout
    public static final String LAYOUT_POPUP_TEMPLET_DIR = LAYOUT_BASE_DIR + "/popup";

    public static final String LAYOUT_POPUP_TEMPLET_URL = LAYOUT_POPUP_TEMPLET_DIR + "/popup-layout.jsp";
